...
// WITH EVALUATE
// await page.evaluate(async (REPEATS) => {
//   const myt = "typing ".repeat(REPEATS).split(" ");
//
//   const logButton = document.querySelector(".logB") as HTMLElement | null;
//   if (!logButton || logButton.textContent !== "Log HTML") return [];
//
//   const enterButton = document.querySelector(".enterB") as HTMLElement | null;
